      ...
      <v-container fluid fill-height>
        <v-layout align-center justify-center>
          <div class="text-md-center">
            <h1>404</h1>
            <h2 class="my-3 headline">Извините, но страница не найдена</h2>
            <div>
    ...
    <template v-if="error.statusCode === 403">
      <v-container fluid fill-height>
        <v-layout align-center justify-center>
          ...
          <div class="text-md-center">
            <h1>403</h1>
            <h2 class="my-3 headline">Извините, доступ запрещен.</h2>
            <div>
              <v-btn color="primary" @click="goHome">На главную</v-btn>
            </div>
          </div>
    ...
    <template v-if="error.statusCode === 500">
      <v-container fluid fill-height>
        <v-layout align-center justify-center row>
          ...
          <div class="text-md-center">
            <h1>500</h1>
            <h2 class="my-3 headline">Извините, сервер не работает.</h2>
            <div>
              <v-btn color="primary" @click="goHome">На главную</v-btn>
            </div>
          </div>
