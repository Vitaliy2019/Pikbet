...
module.exports = {
  ...
  head: {
    title:
      "Прогнозы на спорт. Стань успешным каппером. Регистрируйся на сайте и зарабатывай на своих прогнозах. Следи за успешными капперами. Повторяй ставки и выигрывай вместе с ними.",
    meta: [
      {
        charset: "utf-8",
      },
